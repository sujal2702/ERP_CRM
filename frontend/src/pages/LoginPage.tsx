    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 border-b border-slate-800 text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-blue-600/20 text-blue-400 mb-4 border border-blue-500/30">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-xl transition duration-150 shadow-lg shadow-blue-600/20 disabled:opacity-50 flex justify-center items-center text-sm"
          >
            {isSubmitting ? (
